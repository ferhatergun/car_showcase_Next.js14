            ...
            <div className='fixed inset-0 overflow-y-auto'>
                ...
                justify-center p-4 text-center'>
                    ...
                    leaveTo='opacity-0 scale-95'>
                        ...
                        rounded-2xl bg-white text-left shadow-xl p-6 ">
                            <button
                            type='button'
                            onClick={closeModal}
                            ...
                            <div className='flex-1 flex flex-col gap-3'>
                                ...
                                bg-cover bg-center rounded-lg'>
                                    <Image src={generateCarImageUrl(car,'angle')} alt="car hero" 
                                    className='object-contain' fill priority/>
                                </div>
                                <div className='flex gap-3'>
                                    <div className='flex-1 relative w-full
                                    h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car,'29')} alt="car hero" 
                                        className='object-contain' fill priority/>
                                    </div>
                                    <div className='flex-1 relative w-full
                                    h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car,'33')} alt="car hero" 
                                        className='object-contain' fill priority/>
                                    </div>
                                    <div className='flex-1 relative w-full
                                    h-24 bg-primary-blue-100 rounded-lg'>
                                        <Image src={generateCarImageUrl(car,'13')} alt="car hero" 
                                        className='object-contain' fill priority/>
                                    </div>
                                </div>
                            </div>
